  ...
  if (g_InControlState.fHexOn) {
    ...
    if (bExtraCycle>0){ 
...
#ifdef DEBUG
      unsigned long lTimerBeforeDelay = millis();
#endif
      ...
      if (g_fDebugOutput) {
        ...
        //              DBGSerial.print(lTimeWaitEnd-lTimerStart, DEC);
        //              DBGSerial.print(" ");
        //              DBGSerial.print(lTimerBeforeDelay-lTimerStart, DEC);
        //              DBGSerial.print(" ");
        //              DBGSerial.println(lTimerEnd-lTimerBeforeDelay, DEC);
      }
#endif
    }
#ifdef DEBUG
